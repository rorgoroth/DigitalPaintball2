...
void CL_InitLocal (void)
{
	...
	cl_blockedwords =	Cvar_Get("cl_blockedwords", "rape,camp,camper,campre,camepr,liner,lining,fuck,fuc k,fuq,phuck,fukc,shit,sh!t,sh1t,dick,d ick,bitch,whore,cock,fag,walled,horrible,terrible,nigg,pussy,cunt,slut,stfu,asshole,assmunch,ass,owned,ownd,suck,retarded,dumbass,dumb ass,prick,douche,noob,pansy,slut,plowed,idiot,horribad,newbed,heil hitler,heil,hitler,your mum,motherfucker,bullshit,arsch,arschloch,fick,fotze,muschi,schwuchtel,schwutte,spast,spacko,scheise,scheisse,pisser,kacker,kakker", 0); // viciouz - swear filter - jit, added some more - T3RR0R15T, added some more again
